...
**Answer:** An increase to $x_{1}$ by two would increase the odds by $2e^{\beta_1}$.

$$
\frac{Pr(Y = 1 | X)}{1 - Pr(Y = 1 | X}) = e^{\beta_0 + 2\beta_1x_1}
$$
...
**Answer:** When $\beta_1$ is negative and $x_1$ approaches $\infty$, p approaches $0$. When $x_1$ approaches $\infty$, p approaches $1$.